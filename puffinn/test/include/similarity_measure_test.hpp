...
namespace similarity_measure {
    ...
    TEST_CASE("CosineSimilarity::compute_similarity") {
        ...
        auto stored_1 = to_stored_type<UnitVectorFormat>(v1, dataset.get_description());
        auto stored_2 = to_stored_type<UnitVectorFormat>(v2, dataset.get_description());
        float res16 = CosineSimilarity::compute_similarity(
            stored_1.get(), stored_2.get(), dataset.get_description());
        float expected = 0.7;
        ...
        stored_1 = to_stored_type<UnitVectorFormat>(long_1, dataset.get_description());
        stored_2 = to_stored_type<UnitVectorFormat>(long_2, dataset.get_description());
    ...
    TEST_CASE("L2Distance::compute_similarity") {
        Dataset<RealVectorFormat> dataset(32);
    ...
    TEST_CASE("JaccardSimilarity::compute_similarity") {
        ...
        auto d = dataset.get_description();
